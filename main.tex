...
The following figure shows the most relevant values of $\alpha$, for $\beta_w = 1$ and $\beta_h = 1$
...
\begin{figure}[H]
	...
	\begin{subfigure}{.4\textwidth}
		...
		\caption{$\alpha_W = 5 $, $\alpha_H = 0.1$}
	\end{subfigure}%
	\caption{$W$ matrix for  $\beta_w = 1$ and $\beta_h = 1$}
\end{figure}   
...
\begin{figure}[H]
	\begin{subfigure}{.4\textwidth}
		...
		\caption{$\alpha_W = 1 $, $\alpha_H = 5 $}
	\end{subfigure}%
	\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{{betas=1/W_alph_1_alpw_0.1_beth_1_betw_1}.png}
		\caption{$\alpha_W = 1 $, $\alpha_H = 10$}
	\end{subfigure}%
	
	\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{{betas=1/W_alph_5_alpw_0.1_beth_1_betw_1}.png}
		\caption{$\alpha_W = 5 $, $\alpha_H = 5 $}
	\end{subfigure}%
	\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[width=.8\linewidth]{{betas=1/W_alph_10_alpw_5_beth_1_betw_1}.png}
		\caption{$\alpha_W = 5 $, $\alpha_H = 0.1$}
	\end{subfigure}%
